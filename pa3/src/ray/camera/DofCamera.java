...
public class DofCamera {
   ...
   */
  public DofCamera(Point3 eye, Point3 target, Vector3 up, double inXFOV, double inYFOV) {
  ...
  public void setLensRadius(double lensr) {
    lensRadius = lensr;

  }
  public void setFocalDistance(double focald) {
